...
head:
  ...
  meta:
    - property: 'og:locale'
      content: 'de_DE'
    - name: 'description'
      content: 'Strategien für schlanke Docker Images: Erfahren Sie, wie Sie Docker Images mit Multi-Stage Dockerfiles und optimierten Basis-Images effizient und klein halten. Perfekt für Entwickler.'
    - property: 'og:type'
      content: 'website'
    - property: 'og:title'
