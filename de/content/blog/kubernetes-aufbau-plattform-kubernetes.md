...
head:
  ...
  meta:
    - property: 'og:locale'
      content: 'de_DE'
    - name: 'description'
      content: 'Erfahren Sie, wie Sie mithilfe von Kubernetes eine komplexe Plattform aufbauen und welche Tools und Technologien Sie dafür benötigen.'
    - property: 'og:type'
      content: 'website'
    - property: 'og:title'
...
title: "Kubernetes Basics: Der Aufbau einer Plattform mit Kubernetes"
description: 'Erfahren Sie, wie Sie mithilfe von Kubernetes eine komplexe Plattform aufbauen und welche Tools und Technologien Sie dafür benötigen.'
date: '01.06.2023'
autor:
  - Oliver Hientz
technologie: []
