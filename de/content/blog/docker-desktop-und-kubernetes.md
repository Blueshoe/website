...
head:
  ...
  meta:
    - property: 'og:locale'
      content: 'de_DE'
    - name: 'description'
      content: 'Entdecke Docker Desktop und Kubernetes für Entwickler. Erfahre mehr über Installation, Leistung und Nutzung. Lies den vollständigen Artikel!'
    - property: 'og:type'
      content: 'website'
    - property: 'og:title'
...
title: "Docker Desktop und Kubernetes"
description: 'Entdecke Docker Desktop und Kubernetes für Entwickler. Erfahre mehr über Installation, Leistung und Nutzung. Lies den vollständigen Artikel!'
date: '08.03.2023'
autor:
  - Michael Schilonka
technologie:
