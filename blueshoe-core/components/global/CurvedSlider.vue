          ...
          <div class="block xl:hidden relative">
            ...
            >
              ...
              >
                ...
                <div
                  v-else
                  class="ml-24 flex flex-col justify-center h-[350px] md:hidden"
                >
                  <div
            ...
            <div class="swiper-button-prev-curved md:hidden z-50" />
            <div class="swiper-button-next-curved md:hidden z-50" />
          </div>
