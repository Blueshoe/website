...
head:
  ...
  meta:
    - property: 'og:locale'
      content: 'en_US'
    - name: 'description'
      content: 'APIs are essential for coupling services in modern application architectures. We help you discover and implement an API strategy for your applications.'
    - property: 'og:type'
      content: 'website'
    - property: 'og:title'
