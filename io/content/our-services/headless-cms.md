...
- Language-agnostic ([API](/our-services/api-development-company/){.text-white .underline .hover:text-bs-green} can be used with every programming language)
- Front-end-friendly
...
::
::GlobalParagraph{:fontSize="lg" :color="text-white"}
Technologies like static site generators. Front-end frameworks like Vue, React or Angular. Jamstack (development with JavaScript, [APIs](/our-services/api-development-company/){.text-white .underline .hover:text-bs-green} and HTML markup).
::
:::
