...
head:
   ...
   meta:
      - property: 'og:locale'
        content: 'en_US'
      - name: 'description'
        content: 'When it comes to error tracking in our Cloud Native applications Sentry has become our go-to solution. This blog post aims to provide you with our learnings on using Sentry on Unikube’s VueJS based frontend. Read on!'
      - property: 'og:type'
        content: 'website'
      - property: 'og:title'
        content: 'VueJS error tracking with Sentry'
